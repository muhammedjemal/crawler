...
// })
// // now create text file and put the posts by giving new line after each
//     await browser.close();
// }
// main();
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page, post1, post2, post3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    page = _a.sent();
                    return [4 /*yield*/, page.goto('https://www.ethiopianreporter.com/128616/')];
                case 3:
                    _a.sent();
                ...
                case 4:
                    ...
                    // fs.writeFileSync('posts.txt', `${post1}\n${post2}\n${post3}`);
